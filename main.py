...
# Import routers
from routers import admin, operators, reports, sync
...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost",
        "http://localhost:5173",
        "https://fictional-fortnight-sepia.vercel.app",
        "*"  # Keep wildcard for now to ensure connectivity, can restrict later
    ],
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"],
